...
define('DB_DATABASE', 'quote_db'); //make sure to set your database
...
function fetch_all($query)
{
  $data = array();
  global $connection;
  //  setting $connection as global variable allows us to use it outside scope of our function 
  $result = $connection->query($query);
  //  my_sqli_fetch_assoc -- built in php method that converts result to an associative array
