...
{	
    ...
    public function drive()
    {
        ...
        return $this;
        // have to return instance so we can chain functions when calling them below
    }
...
// Have the first instance drive three times, reverse once and have it displayInfo(). 
	...
	echo $red -> drive() -> drive() -> drive() -> reverse() -> displayInfo();  
	echo '<hr>';
...
// Have the second instance drive twice, reverse twice and have it displayInfo(). 
	...
	echo $black -> drive() -> drive() -> reverse() -> reverse() -> displayInfo(); 
	echo '<hr>';

$blue = new Bike(300, "35mph");
// Have the third instance reverse three times and displayInfo().
	echo "<h4>Bike instance blue </h4>";
	echo $blue -> reverse() -> reverse() -> reverse() -> displayInfo(); 
	echo '<hr>';
